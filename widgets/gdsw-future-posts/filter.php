<table class="gdsw-table">
    <tr>
        ...
        <td class="tdright">
            <input class="widefat gdsw-input-text" id="<?php echo $this->get_field_id('filter_category'); ?>" name="<?php echo $this->get_field_name('filter_category'); ?>" type="text" value="<?php echo $instance["filter_category"]; ?>" />
            <br />
